      ...
      >
        ...
        >
          ...
          <Box sx={{ width: { xs: "100%", md: "50%" }, pr: { md: 6 } }}>
            ...
            >
              ...
              <Box component="span" sx={{ color: "primary.main" }}>
                Dortmund – Schnell & Fair Auto verkaufen
              </Box>
            </Typography>

            {/* Beschreibung mit Keyword "verkaufen Dortmund" */}
            <Typography
              sx={{
            ...
            >
              Verkaufen Sie Ihr Auto unkompliziert in Dortmund – egal ob fahrbereit, defekt oder Unfallwagen. Wir garantieren einen <strong>schnellen, fairen Autoankauf Dortmund</strong> mit direkter Auszahlung. Auch ältere Fahrzeuge oder Autos ohne TÜV finden bei uns eine zweite Chance – für Sie und die Umwelt.
            </Typography>
            ...
            >
              ✔ Kein Risiko • ✔ Sofortige Auszahlung • ✔ Sicherer Autoankauf Dortmund
            </Typography>
          </Box>
          ...
          >
            ...
            >
              Auto ankaufen in Dortmund – Fairankauf.de
            </Typography>
            ...
            >
              {/* Hero Image mit Alt + Title */}
              <Box
                component="img"
                src="/autoankauf-dortmund-angebot.png"
                alt="Autoankauf Dortmund – Auto verkaufen schnell & fair | Fairankauf.de"
                title="Autoankauf in Dortmund – Faire Preise & Sofortauszahlung"
              ...
              {/* Sichtbarer H2 über Bild */}
          <Box sx={{ position: "absolute", top: { xs: 16, md: 24 }, left: { xs: 16, md: 24 }, zIndex: 10 }}>
            <Typography
              sx={{
                fontWeight: 900,
                lineHeight: { xs: 1.2, md: 1 },
                fontSize: { xs: "1.4rem", sm: "1.6rem", md: "2.4rem" }, // kleiner auf XS, größer auf MD
                textTransform: "uppercase",
                color: "#fff",
                maxWidth: { xs: "85%", md: "100%" }, // Zeilen umbrechen, falls zu lang
